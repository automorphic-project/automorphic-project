...
The {\it Harish-Chandra--Schwartz space} of $X$ is the space $\mathcal C(X)$ of smooth vectors in the Fr\'echet space of half-densities $f$ on $X$ with $f \in \bigcap_{d >0} L^2(X, (1+r)^d)$, where $r$ is a natural scale function on $X$. 
\end{definition}
...
The space of {\it tempered half-densities} on $X$ is the dual of the topological vector space $\mathcal C(X)$. If a $G$-eigenmeasure $dx$ on $X$ is chosen, the dual of $(dx)^{-\frac{1}{2}} \mathcal C(X)$ is the space of {\it tempered measures}, and the dual of $(dx)^{-\frac{1}{2}} \mathcal C(X)$ is the space of {\it tempered generalized functions}. 
\end{definition}
